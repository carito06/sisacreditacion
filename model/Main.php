...
//        exit();
    ...
    function getEvaluacion() {
        ...
        $query = "SELECT descripcion,idunidad,evaluacion.ponderado,fecha,idevaluacion FROM `evaluacion` inner join tipo_evaluacion on evaluacion.idtipo_evaluacion = tipo_evaluacion.idtipo_evaluacion
                  ";
        $sth = $this->db->prepare($query);
        $sth->execute();
        return $sth->fetchAll();
