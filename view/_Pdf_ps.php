       ...
       <table id="tabladetalle" border="0" style="background-color: #F7F7F7;">
                        <tbody style=" font-size: 14px; text-align: left">
                         ...
                         <?php foreach ($rows as $key => $value) { ?>
                            ...
                            <tr class="fil">
                                 <td>1.1 TEMA DEL EVENTO: <?php echo strtoupper(utf8_encode($value[1])); ?> </td>  
                            </tr>
                          
                            <tr class="fil">
                                <td><span>1.2 TIPO EVENTO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[2])); ?></span></td>
                                
                            </tr>
                             <tr class="fil">
                                <td><span>1.3 FECHA DE INICIO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[4])); ?></span></td>
                                
                            </tr>
                             <tr class="fil">
                                <td><span>1.4 FECHA DE FIN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[5])); ?></span></td>
                                
                            </tr>
                             <tr class="fil">
                                <td><span>1.5 HORA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[7])); ?></span></td>
                                
                            </tr>
                            <tr class="fil">
                                    <td><span>2.- UBICACION &nbsp;&nbsp;: </span></td>
                                    
                                </tr>
                                 <tr class="fil">
                                <td><span> LUGAR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[6])); ?></span></td>
                                
                            </tr>
                                <tr class="fil">
                                    <td> El Evento se encuentra ubicado en el Departamento de <?php echo strtoupper(utf8_encode($value[10]));?>
                                        , en la Provincia de <?php echo strtoupper(utf8_encode($value[9])); ?> y en el distrito de <?php echo strtoupper(utf8_encode($value[8])); ?>
                                    </td>
                                   
                                </tr>
                                <tr class="fil">
                                    <td><span>3.- ENCARGADO &nbsp;&nbsp;: </span></td>
                                    
                                </tr>
                                
                               <td><span>3.1 DOCENTE ENCARGADO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[11])); ?></span></td>
                     
                               <tr class="fil">
                                    <td><span>4.- Participante &nbsp;&nbsp;: </span></td>
                              
                                </tr>
                              
                               <td><span>4.1 Alumno Participante &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <?php echo strtoupper(utf8_encode($value[12])); ?></span></td>
